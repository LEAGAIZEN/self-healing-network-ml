...
# 1. DEFINE THE CORRECT SERVER CODE
server_code = """
...
# 2. FORCE-WRITE THE FILE (Fixes empty file issues)
file_path = os.path.join("app", "api", "server.py")
...
try:
    ...
    print(f"❌ ERROR: Could not find folder 'app/api'. Please check your folders.")
    sys.exit(1)

# 3. LAUNCH THE SERVER AUTOMATICALLY
